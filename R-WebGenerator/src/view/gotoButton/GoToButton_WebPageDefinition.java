...
public class GoToButton_WebPageDefinition extends JButton implements ActionListener {
	public GoToButton_WebPageDefinition() {
		super(GeneratorProperty.japanese()?"Webページ定義画面へ":"Go To Web Page Definition");
