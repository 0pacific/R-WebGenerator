...
public class GoToButton_TableDefinition extends JButton implements ActionListener {
	public GoToButton_TableDefinition() {
		super(GeneratorProperty.japanese()?"テーブル定義画面へ":"Go To Table Definition");
